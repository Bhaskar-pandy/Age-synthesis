...
![Teaser image](https://raw.githubusercontent.com/Bhaskar-pandy/Age-synthesis/main/stylegan2-ada-pytorch/docs/stylegan2-ada-teaser-1024x252.png)
...
```bash
git clone https://github.com/Bhaskar-pandy/Age-synthesis.git
cd Age-synthesis
python -m venv .venv
...
### 2. Download Neural Weights
The large model weights are not stored in Git. Run this script to download them automatically (approx. 360MB):
```bash
...
![Training curves](https://raw.githubusercontent.com/Bhaskar-pandy/Age-synthesis/main/stylegan2-ada-pytorch/docs/stylegan2-ada-training-curves.png)
